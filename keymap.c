...
[_QWERTY] = LAYOUT(
  ...
  LSFT_T(KC_CAPS),KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_CAD,  _______, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_ENT,
 ...
 */
 [_RAISE] = LAYOUT(
  ...
  KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,   _______,  _______,  KC_PLUS, KC_MINS, KC_PLUS,  KC_LBRC, KC_RBRC, KC_BSLS,
                             _______, _______, _______,  _______,  _______,  _______, _______, _______
),
